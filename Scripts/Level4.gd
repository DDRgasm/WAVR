...
@onready var box_palette_event: Node2D = $BoxPaletteEvent
...
# Quadrant disabling schedule for Level 4
var quadrant_schedule_active: bool = true
var time_elapsed: float = 0.0
var quadrant_phase: int = 0  # Track which phase we're in (0-5)

# Box palette animation tracking
var box_palette_phase: int = 0  # Track which animation to play (0-5)
...
func _ready():
	...
	# Start box palette animation
	if box_palette_event and box_palette_event.has_node("AnimationPlayer"):
		var anim_player = box_palette_event.get_node("AnimationPlayer")
		anim_player.play("level4act1")
		box_palette_phase = 1
...
func handle_quadrant_schedule(delta: float):
	...
	if quadrant_phase == 0 and time_elapsed >= 30.0:
		...
		quadrant_phase = 1
		# Play box palette animation act 2
		if box_palette_event and box_palette_event.has_node("AnimationPlayer") and box_palette_phase == 1:
			var anim_player = box_palette_event.get_node("AnimationPlayer")
			anim_player.play("level4act2")
			box_palette_phase = 2
	...
	# Phase 1 -> 2: 60 seconds - Enable right, disable left quadrants (TL=0, BL=2)
		...
		quadrant_phase = 2
		# Play box palette animation act 3
		if box_palette_event and box_palette_event.has_node("AnimationPlayer") and box_palette_phase == 2:
			var anim_player = box_palette_event.get_node("AnimationPlayer")
			anim_player.play("level4act3")
			box_palette_phase = 3
	...
	# Phase 2 -> 3: 90 seconds - Enable left, disable right quadrants
		...
		print("Level4: Disabled right quadrants at ", time_elapsed, "s")
		quadrant_phase = 3
		# Play box palette animation act 4
		if box_palette_event and box_palette_event.has_node("AnimationPlayer") and box_palette_phase == 3:
			var anim_player = box_palette_event.get_node("AnimationPlayer")
			anim_player.play("level4act4")
			box_palette_phase = 4
	...
	# Phase 3 -> 4: 120 seconds - Enable right, disable left quadrants
		...
		print("Level4: Disabled left quadrants at ", time_elapsed, "s")
		quadrant_phase = 4
		# Play box palette animation act 5
		if box_palette_event and box_palette_event.has_node("AnimationPlayer") and box_palette_phase == 4:
			var anim_player = box_palette_event.get_node("AnimationPlayer")
			anim_player.play("level4act5")
			box_palette_phase = 5
	...
	# Phase 4 -> 5: 150 seconds - Enable all quadrants
		...
		# Play box palette animation act 6
		if box_palette_event and box_palette_event.has_node("AnimationPlayer") and box_palette_phase == 5:
			var anim_player = box_palette_event.get_node("AnimationPlayer")
			anim_player.play("level4act6")
			box_palette_phase = 6
